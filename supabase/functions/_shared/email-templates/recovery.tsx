  ...
  <Html lang="it" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Abbiamo ricevuto una richiesta di reset password per {siteName}. Clicca sul pulsante qui sotto per scegliere una nuova password.
        </Text>
        ...
        <Hr style={hr} />
        <Text style={footer}>
          Se non hai richiesto il reset, puoi ignorare questa email. La tua password non verrà modificata.
        </Text>
      </Container>
    </Body>
  </Html>
